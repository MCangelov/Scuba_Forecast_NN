...
#Call the API
def get_data(USERNAME, PASSWORD, OUTPUT_FILENAME, DATE_START, DATE_END):
    ...
    bs_data_request = motu_option_parser(API_request, USERNAME, PASSWORD, OUTPUT_FILENAME, DATE_START, DATE_END)
    motuclient.motu_api.execute_request(MotuOptions(bs_data_request))

    bs_dataset = xr.open_dataset(OUTPUT_FILENAME)
    bs_df = bs_dataset.to_dataframe()
